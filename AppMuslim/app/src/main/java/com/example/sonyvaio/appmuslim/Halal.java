...
import com.example.sonyvaio.appmuslim.ClientAsyncTaskClass;
import com.example.sonyvaio.appmuslim.ListProdukAdapter;
import com.example.sonyvaio.appmuslim.Produk;
import com.example.sonyvaio.appmuslim.R;
...
public class Halal extends AppCompatActivity {
    ...
    private void loadData(String kw){
        ...
        try {
            ...
            task.mProgress(this.progressBar);
            task.execute();
